...
def harmonic_fit_genes(data, phases, genes=None, counts=None, fixed_disp=0.1, fit_disp=False, layer=None):
    """
    ...
    # Create polar parameter version
    params_g_pol = polar_genes_pandas(params_g.copy())
    
    return params_g, params_g_pol